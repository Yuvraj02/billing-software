...
import { getCompletedWorkByName } from "../../api";
...
function SearchedCustomerByName(prop: SearchedCustomerData) {

    const searchedQuery = useQuery({
        queryKey: ['searched_completed_work_by_name'],
        queryFn: () => getCompletedWorkByName(prop.customerName),
        enabled: prop.isSearched
    })
...
export default SearchedCustomerByName